		...
		<div id="content_inner">
		  <div class="post">
	        ...
	        <form name="change" onsubmit="return validForm(document.change)" action="${pageContext.request.contextPath}/Action">
	          ...
	          <div>
	            <font color="red">Inserire i dati richiesti per modificare la password.</font>
	            <br/>
	              Ad operazione effettuata verrete riportati alla pagina di login e potrete da subito accedere utilizzando la nuova password.
	            <br/>
	            <br/>
	            <br/>
	            ...
	            <table>
	              <tr>
	                <td> <b>Username:&nbsp;&nbsp;</b> </td>
	                <td> <%= request.getParameter("username") != null ? request.getParameter("username") : "" %>
	                <input name="oldusername" class="smusso" size="20" type="hidden" value="<%=request.getParameter("username") %>"/> </td>
	              </tr>
	              <tr>
	                <td colspan="2"></td>
	              </tr>
