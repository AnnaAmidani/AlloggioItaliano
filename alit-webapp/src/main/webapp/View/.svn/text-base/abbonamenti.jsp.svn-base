	...
	<div class="left" id="content">
      ...
      <br/>
        <table class="pay_1">
         <tr>
          <td>
          L'abbonamento annuale ad Alloggio Italiano costa soltanto 14,64 euro (iva inclusa 22%) e vi permette
          ...
          <td>
            ...
            <b><img src="${pageContext.request.contextPath}/View/img/li.gif" width="10px"/>&nbsp;&nbsp;pubblicazione di segnalazioni relative a eventi in zona</b><br/>
          </td>
          </tr>
          <tr>
          <td>&nbsp;</td>
