        ...
        <tr>
          ...
          <td id="next1" class="navLblScheda">
			...
			<br/><br/>
			  ...
			  if( JspServiceImpl.getInstance().imagePresent(userId, "02") )
			  {
			  %>
			  ...
			  if( JspServiceImpl.getInstance().imagePresent(userId, "03") )
			  {
			  %>
			  ...
			  if( JspServiceImpl.getInstance().imagePresent(userId, "04") )
			  {
			  %>
			  ...
			  if( JspServiceImpl.getInstance().imagePresent(userId, "05") )
			  {
			  %>
			  ...
			  if( JspServiceImpl.getInstance().imagePresent(userId, "06") )
			  {
			  %>
			  ...
			  if( JspServiceImpl.getInstance().imagePresent(userId, "07") )
			  {
			  %>
			  ...
			  if( JspServiceImpl.getInstance().imagePresent(userId, "08") )
			  {
			  %>
			  ...
			  if( JspServiceImpl.getInstance().imagePresent(userId, "09") )
			  {
			  %>
			  ...
			  if( JspServiceImpl.getInstance().imagePresent(userId, "10") )
			  {
			  %>
			  ...
			  <div id="slide">
			    ...
			    <br/>
			  <div class="arrow1"><img class="arrow" title="immagine precedente" src="${pageContext.request.contextPath}/View/img/left_arrow_2.png" onclick="changeSlide('back', <%=userId %>, '<%=context %>')"/></div>
			  <div class="arrow2"><img class="arrow" title="immagine successiva" src="${pageContext.request.contextPath}/View/img/right_arrow_2.png" onclick="changeSlide('back', <%=userId %>, '<%=context %>')"/></div>
 				<br/><br/>
			 </div>
