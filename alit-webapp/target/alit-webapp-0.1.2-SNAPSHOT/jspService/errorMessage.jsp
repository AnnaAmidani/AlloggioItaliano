  ...
  <div id="main">
	<div class="left" id="content">
		<div id="content_inner">
          ...
          if(message != null)
          {
            %> <h2 class="donestyle"> <%= message %> </h2> <%
          }

          String messageBoundle = (String) request.getAttribute("messageBoundle");
          if(messageBoundle == null)
            messageBoundle = (String) request.getParameter("messageBoundle");
          if(messageBoundle != null)
          {
            %> <h2 class="donestyle"> <%= messageBoundle %> </h2> <%
          }

          if(message == null && messageBoundle == null)
          {
            %>
              <p>Si è verificato un'errore inatteso. Ci scusiamo per l'inconveniente</p>
