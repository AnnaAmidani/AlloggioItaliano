	...
	<div class="left" id="content">
		<div id="content_inner">
		  <div class="post">
	        ...
	        <p>l'immagine non &egrave; stata caricata correttamente.<br />
	        Si invita a controllare che il file non sia corrotto, e a riprovare.</p>
	        <p>
	          <br />
	          <a href="<%= context + response.encodeURL("/View/pubblicita.jsp")%>">vai a scheda pubblicit&agrave;</a>
	          <br /> <br />
	          <a href="<%= context + response.encodeURL("/View/Registrazione3.jsp")%>">vai a scheda di registrazione 3</a>
	        </p>
